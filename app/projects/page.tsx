...
const projects = [
  ...
  {id:8,category:'網站設計' as ProjectCategory,title:'網站重構',source:'/projects/website-redesign',preview:'https://www.figma.com/proto/jG1udIPMgzfBrN73lw9J1B/bbh%E9%A6%96%E9%A0%81?node-id=1-12&scaling=min-zoom&page-id=0%3A1&starting-point-node-id=1%3A12&show-proto-sidebar=1',kind:'dual'},
      ...
      <section className="projects-page">
        ...
        <div className="embed-grid">
          {projects.map(project=><article key={project.id} className="embed-project">
            <div className="embed-square"><div className="embed-toolbar"><span>0{project.id}</span><span>{project.kind==='figma'?'FIGMA EMBED':project.kind==='internal'||project.kind==='dual'?'CASE STUDY':'FULL PAGE'}</span></div>{project.kind==='internal'?<a className="project-cover" href={project.source}><img src={project.cover} alt="APP Design 作品封面"/><span>VIEW PROJECT →</span></a>:<iframe src={embedUrl(project)} title={project.title} loading="lazy" allowFullScreen allow="fullscreen"/>}</div>
